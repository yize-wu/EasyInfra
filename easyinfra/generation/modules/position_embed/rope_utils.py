...
def _compute_yarn_parameters(
    config: Any, device: "torch.device", seq_len: Optional[int] = None, **rope_kwargs
) -> Tuple["torch.Tensor", float]:
    """
...
def _validate_default_rope_parameters(config: Any):
...
def _validate_linear_scaling_rope_parameters(config: Any):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
...
def _validate_dynamic_scaling_rope_parameters(config: Any):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
    required_keys = {"rope_type", "factor"}
...
def _validate_yarn_parameters(config: Any):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
    required_keys = {"rope_type", "factor"}
...
def _validate_longrope_parameters(config: Any):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
...
def _validate_llama3_parameters(config: Any):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
...
def rope_config_validation(config: Any):
    """
    Validate the RoPE config arguments, given a `Any` object
    """
    rope_scaling = getattr(config, "rope_scaling", None)  # not a default parameter in `Any`
